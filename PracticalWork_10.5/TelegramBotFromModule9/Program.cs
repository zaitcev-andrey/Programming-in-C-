...
namespace Task_1
{
    ...
    public class Program
    {
        ...
        /// <returns></returns>
        static public string GetAllFiles(string pathToDirectory = "../")
        {
        ...
        async static public Task updateHandler(ITelegramBotClient botClient, Update update, CancellationToken token)
        {
        ...
        public static async Task Error(ITelegramBotClient botClient, Exception exc, CancellationToken token)
        {

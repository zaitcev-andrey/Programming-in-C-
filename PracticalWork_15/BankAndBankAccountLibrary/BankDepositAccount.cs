...
namespace BankAccountLibrary
{
    ...
    public class BankDepositAccount : BankAccount
    {
        ...
        public static BankDepositAccount operator +(BankDepositAccount bankAccount, double money_)
        {
            Enum.TryParse(bankAccount.Name, out BankDepositAccountNames name);
            return new BankDepositAccount(bankAccount.Id, name, bankAccount.Money + money_);
        }
